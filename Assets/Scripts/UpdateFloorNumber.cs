...
public class UpdateFloorNumber : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        floorNumber = stairwell.childCount - 1;
        textObj.text = ToRoman(floorNumber);
    }

    public static string ToRoman(int number)
    {
        if ((number < 0) || (number > 3999)) throw new ArgumentOutOfRangeException("INSERT NORMIES");
